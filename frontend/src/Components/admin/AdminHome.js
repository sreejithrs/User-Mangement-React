...
const AdminHome = () => {
    ...
    return (
        ...
        <div style={{height:'120vh', width:"100%" ,backgroundColor:"#FAF0E6"}}>
            <Header admin={'admin'} />
                        ...
                        <Table  hover >
                            ...
                            <tbody>
                                ...
                                return (
                                    ...
                                    <td>{e.phone}</td>
                                    <td>{e.email}</td>
                                    <td><Button variant="contained" color="warning" className='px-4' startIcon={<EditIcon/>} onClick={() => { editHandle(e._id) }} >Edit</Button> <Button variant="outlined" color="error" startIcon={<DeleteIcon />} className='px-3' onClick={() => { clickHandler(e._id) }}>Delete</Button> </td>
